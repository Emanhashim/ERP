...
//finance
public function financesignup($firstname,$lastname,$username,$password,$accId){
    ...
    if($stm->execute()){
        ...
        public function financeps($username,$password){
             $pass=md5($password);
         $stm= $this->conn->prepare("insert into account(username,password,role) values(?,?,'Finance');");
         $stm->bind_param("ss",$username,$pass);
         if($stm->execute()){
             return 1;
        ...
        // public function ceosignup($firstname,$lastname,$username,$password,$accId){
        ...
        //    }
        // public function ceops($username,$password){
        //      $pass=md5($password);
        //  $stm= $this->conn->prepare("insert into account(username,password,role) values(?,?,'CEO');");
        //  $stm->bind_param("ss",$username,$pass);
        //  if($stm->execute()){
        //      return 1;
