...
$db=new dbcontroller();
$result=$db-> financeps($username,$password);       
if($result=='1'){
    $accId = $db->getId($username,$password);
    $result=$db->financesignup($firstname,$lastname,$username,$password,$accId);
 $success = true;
...
<body>
    ...
    <form class="text-center border border-light p-5" style="margin-top: 40px; margin-bottom: 80px; background-color: white;" action="./finance.php" method="post">
    ...
    <div class="form-row mb-4">
         ...
         <button class="btn btn-outline-amber" type="submit" name="submit">
          ...
          <p class="font-small grey-text d-flex justify-content-center">Already have an account? <a href="../../view/login.php" class="dark-grey-text font-weight-bold ml-1">Login</a></p>
    </form>
        </div>
  ...
  <!-- MDB core JavaScript -->
  <script type="text/javascript" src="../../view/js/mdb.min.js"></scr
