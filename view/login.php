    ...
    <body>
       ...
       <div class="header pt-3 white lighten-2">
        <div class="row d-flex justify-content-center">
            <img src="bazraa.jpg" style="width: 20%; border-radius: 50%;">
           ...
           <form style="height: 400px; "action=login.php method="POST">
            ...
            <!--<button type="button" class="btn btn-white">Log in</button>--> 
                 ...
                 <p class="font-small grey-text d-flex justify-content-center">Don't have an account? <a href="landing.php"  class="dark-grey-text font-weight-bold ml-1"><u> Sign up</u></a></p>
            </div>
            </form>
           </div>
           </section>
