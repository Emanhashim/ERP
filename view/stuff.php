...
$db=new dbcontroller();
$result=$db-> stuffps($username,$password);       
if($result=='1'){
    $accId = $db->getId($username,$password);
    $result=$db->stuffsignup($firstname,$lastname,$username,$password,$accId);
 $success = true;
...
<body>
    ...
    <form class="text-center border border-light p-5" style="margin-top: 40px; margin-bottom: 80px; background-color: white;" action="./stuff.php" method="post">
